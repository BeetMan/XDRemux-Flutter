...
public enum AppleReturnedPhotoWritebackBridge {
    public struct Report {
        public let width: Int
        public let height: Int
        public let restoredCanvas: CGRect
        public let preservedISOGainMap: Bool
        public let restoredOppoEntries: [String]
    }
    ...
    public static func restore(
        ...
        let returnedGainMap = CGImageSourceCopyAuxiliaryDataInfoAtIndex(
            returnedSource,
            0,
        ...
        let outputHasGainMap = CGImageSourceCopyAuxiliaryDataInfoAtIndex(
            outputSource,
            0,
            kCGImageAuxiliaryDataTypeISOGainMap
        ) != nil
    ...
    public static func copyAppleOutput(
